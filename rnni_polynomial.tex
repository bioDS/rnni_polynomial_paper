...
Another and from a biological point of view very important property of our algorithm is that for a pair of trees sharing some information, more specifically clusters, which we introduce later in the paper, this information is preserved on the computed path.
