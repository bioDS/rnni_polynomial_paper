...
Note that in the version of $\findpath$ in \autocite{Collienne2019} the output is a shortest path as a sequence of trees.
If just the distance between trees is wanted, the algorithm can be implemented such that is runs in under a minute for tens of thousands of leaves. 
