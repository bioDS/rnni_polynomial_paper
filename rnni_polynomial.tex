...
Note that if two trees have a cluster in common, every tree on the path computed by $\findpath$ contains this cluster as well.
An Python implementation of this algorithm can be found in GitHub~\autocite{Collienne2019}.
