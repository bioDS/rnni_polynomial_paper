...
\summary{Motivation: computing distances between trees is a well-known long-standing problem in theoretical computers science, with wide range of applications and many popular algorithms rely on these.}

\summary{Motivation: All known graph-based tree rearrangement distances are NP-hard, and it took many years and paper to prove that.}
