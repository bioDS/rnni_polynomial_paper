...
\proof
	...
	We can assume that no counter-example exists for paths shorter than $p$, so the first tree $T'$ after $T$ on $p$ does not contain the cluster $C$.
	...
	\todo{Would be good to add nodes $(C)_T$ and $(C)_{T'}$ on the figure.}
