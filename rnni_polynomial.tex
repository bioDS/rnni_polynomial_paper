...
We are aware of a shorter proof of this statement but with the presented proof we gain additional insight into how shortest paths in $\rnni(\epsilon)$ are related to each other for different values of epsilon.
\end{proof}
