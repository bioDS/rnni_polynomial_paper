...
Of particular interest in various applications are internal nodes of these trees, and more specifically their ordering, which we will will also refer to as ranking.
For example in species evolution, where internal nodes of trees correspond to speciation events, the ranking of the tree shows in which order divergence event happened.
...
Other research fields where ranking trees plays an important role are viral epidemiology, where the ranking shows the order of transmissions \autocite{Ypma2013-zm}, and language evolution \autocite{Bouckaert2018-sf, Gray2009-jy}, which reveals how human populations expanded across different continents.
Phylogenetic trees are nowadays also commonly used in the research of cancer evolution \autocite{Potter2013-go, Jiao2014-ut}.
In cancer phylogenies, internal nodes can refer to emergence of metastasic clones, and their ranking shows in which order metastasis grew \autocite{Lote2017-hg}.
