...
Although ranked phylogenetic trees are one of the central objects of interest in applications, the computational complexity of the shortest path problem for these trees remained an unsolved problem for decades.
...
We also propose a study of the parameter for the weight difference between move types that changes the complexity of the shortest path problem in our graph from quadratic to $\np$-hard.
