...
\proof
	To prove the theorem we assume the contradictory, that is, there is a shortest path between $T$ and $R$ in $\rnni$ that contains a tree that does not have $C$ as a cluster, even though both $T$ and $R$ contain $C$.
