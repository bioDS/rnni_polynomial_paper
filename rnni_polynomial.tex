...
The with our algorithm efficient computation of $\rnni$ distances facilitates the inference of trees where the order of divergence events is relevant, for example in virus or cancer evolution.
