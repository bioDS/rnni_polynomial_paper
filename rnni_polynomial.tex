...
These are trees where all internal nodes are uniquely ranked by elements of the set $\{1, \ldots, s\}$, where $s \geq n - 1$ so that children have strictly smaller ranks than their parent.
