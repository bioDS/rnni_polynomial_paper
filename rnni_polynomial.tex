...
One major problems in computational biology is the reconstruction of evolutionary histories, also known as phylogenetic trees, from sequence data such as RNA, DNA, or protein sequences.
...
In this paper we provide an algorithm that computes distances between ranked trees efficiently and is biologically meaningful.
...
The with our algorithm efficiently computable $\rnni$ distances between ranked trees facilitates the inference of trees where the order of divergence events is relevant, for example in virus or cancer evolution.
