...
\proof
	Let $T$ and $R$ be trees in $\rnni(0)$, and let $n$ be the number of their leaves.
    ...
    Let $p_\epsilon$ be such a shortest path in $\rnni(\epsilon)$ with $\epsilon := \frac{1}{r+1}$, where $r = \Delta(\rnni)$ is the diameter of $\rnni$.
