...
And since the first move on $\fp(T,R)$, that decreases the rank of $(C_k)_T$, involves nodes with ranks not higher than $t+2$, the most recent common ancestor of $C_k$ has rank not higher than $t+1$ after this move.
Hence $k \leq t + 1$.
