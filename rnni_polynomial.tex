...
The most popular such operations are the nearest neighbour interchange, subtree prune and regraft, and tree bisection and reconnection.
...
For example, fixed-parameter tractable algorithms are known to compute distances under the subtree prune and regraft operation.
...
\todo{LC: Do we really want to use "we" here?}
