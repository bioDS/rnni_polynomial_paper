...
We propose to study a family of shortest path problems indexed by this parameter, which is both theoretically and biologically relevant, with computational complexity varying from quadratic to $\np$-hard.
\end{abstract}
...
This parametrisation is not only of interest because of the varying complexity of $\decprob{\rho}$ depending on $\rho$, but also because of its biological motivation.
