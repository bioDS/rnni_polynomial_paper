...
In general one can say that $\nni$ only allows local changes, while $\tbr$ operations provide the most global changes in this list of rearrangement operations.
For $\nni$, the question of whether it is $\np$-hard to compute distances has been open for decades and was finally settled by \textcite{Dasgupta2000-xa}.
...
Interestingly fixed parameter tractable algorithms for computing $\spr$ distances exist \autocite{Whidden2010-bw, Bordewich2005-nx, Whidden2018-fw}, and finding such algorithms still is a very active area of research.
