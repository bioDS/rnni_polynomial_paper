...
Note we chose this name as these graphs are a generalisation of the \emph{ranked nearest neighbour interchange} ($\rnni$) graph as introduced in \autocite{Collienne2019-ca}, where $\rho = 1$.
