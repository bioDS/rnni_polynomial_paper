...
\item Rank move on interval $[(T)_{t+1}, (T)_{t+2}]$.
Again, depending on whether or not the ranks of $(C_k)_{T_1}$ and $(C_k)_R$ coincide, we arrive at the conclusion that either $T'_1 = T$ or $T_2$ and $T'_2$ are $\rnni$ neighbours, similar to case~\ref{case:rank_move_interval_above}.
