...
\begin{itemize}
\item if needed: edge vs rank intervals, subtrees induced by clusters, discrete time-trees (for generalising the proof), (ranked and unranked) tree topologies (for generalisation).
