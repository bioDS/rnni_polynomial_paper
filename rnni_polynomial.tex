...
\proof
For $\rho > 1$ a counterexample is given by trees (see Figure~\ref{fig:fp_rho_greater_1_counterexample})\\
...
For $\rho < 1$ a counterexample is given by trees (see Figure~\ref{fig:fp_rho_less_1_counterexample})\\
...
However, the path from $T$ to $[\{a_3,a_4\},\{a_1,a_2\},\{a_1,a_2,a_3,a_4\}]$ to $[\{a_3,a_4\},\{a_3,a_4,a_1\},\{a_1,a_2,a_3,a_4\}]$ to $R$ consists of one rank move followed by two $\nni$ moves and is hence shorter.
\begin{figure}[ht]
\centering
...
\begin{lemma}
Let $0 < \rho_0 < 1$.
If $\decprob{\rho} \in \fpc$ for all $0<\rho<\rho_0$, then ${\decprob{\rho_0} \in \fpc}$.
