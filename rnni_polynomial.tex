...
Note that in all figures we use for illustrating possible moves on $\fp(T,R)$ and $\fp(T',R)$ the positions of tree roots are irrelevant, so we have placed roots to simplify the figures.
