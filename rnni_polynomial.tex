...
Although it is of interest whether the notion of a neighbourhood of a path in $\rnni(\rho)$ can be introduced in such a way that the problem $\decprob{\rho}$ becomes $\pls$-complete for certain values of $\rho$, this question goes beyond the scope of this paper.
