...
\begin{itemize}
\item if needed: edge vs rank intervals, discrete time-trees (for generalising the proof), (ranked and unranked) tree topologies (for generalisation).
