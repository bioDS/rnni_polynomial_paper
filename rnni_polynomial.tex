...
The following proposition, that can be proved by explicitly constructing a counterexample, implies that the algorithm $\findpath$ is not enough to isolate the values of $\rho$ for which $\decprob{\rho}$ is polynomial.
