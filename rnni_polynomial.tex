...
Their result also implies that the number of possible weights a path in $\rrni(\rho)$ can possible have is bounded by a (quadratic)polynomial in the number of leaves.
...
This observation stands in contrast to the hardness results of finding globally shortest paths that we discuss below.
