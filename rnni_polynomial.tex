...
Since $\rnni(\rho)$ is a connected graph with its diameter bounded by a polynomial in the number of tree leaves \autocite{Gavryushkin2018-ol}, the problem $\decprob{\rho}$ in general is in complexity class $\tfnp$ \autocite{Megiddo1991-lr}.

Our main goal is to prove that $\decprob{1}$ is polynomial-time solvable.
